...
-   [[+EWSMS]{.short} Division Chief Scientist (interim)]{.position}
    [(2025-Present)]{.date}
-   [Senior Research Scientist]{.position} [(2021-Present)]{.date}
-   [Research Engineer II]{.position} [(2016-2021)]{.date}
-   [Tech Temp]{.position} [(2015-2016)]{.date}
-   [Graduate Research Assistant]{.position} [(2009-2015)]{.date}
-   [Student Research Assistant]{.position} [(2007-2009)]{.date}
...
-   [Co-lead developer]{.position} on improved simulation framework for
    predicting infrared and visible signatures in complex environments.
